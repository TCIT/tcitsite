...
module.exports = {
  ...
  prompts: [{
    ...
    type: 'list',
    name: 'component',
    message: 'Selecciona un componente base:',
    ...
    name: 'wantHeaders',
    default: false,
    message: 'Necesitas headers?',
  }, {
    type: 'confirm',
    name: 'wantActionsAndReducer',
    default: true,
    message: 'Requieres un tuple de actions/constants/selectors/reducer para este contenedor?',
  }, {
    type: 'confirm',
    name: 'wantSagas',
    default: true,
    message: 'Requieres sagas para flujos asincronicos? (e.g. recolectar data)',
  }, {
    type: 'confirm',
    name: 'wantMessages',
    default: true,
    message: 'Requieres mensajes en i18n (i.e. este componente usara texto)?',
  }],
  actions: (data) => {
